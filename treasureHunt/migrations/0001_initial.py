# Generated by Django 2.2.3 on 2019-07-31 03:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('n_to', models.IntegerField(blank=True, default=None, null=True)),
                ('s_to', models.IntegerField(blank=True, default=None, null=True)),
                ('e_to', models.IntegerField(blank=True, default=None, null=True)),
                ('w_to', models.IntegerField(blank=True, default=None, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
        ),
